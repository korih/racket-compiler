    ...
    ((tmp.33 (rdi tmp-ra.41 a.61 b.62 rbp))
     ...
     (d.64
      (tmp.35
       ...
       c.63
       rbp))
     (f.66 (tmp.37 h.68 g.67 fv0 fv1 d.64 b.62 a.61 tmp-ra.41 c.63 e.65 rbp))
     (h.68 (rdi f.66 d.64 b.62 a.61 tmp-ra.41 c.63 e.65 g.67 rbp))
     (tmp.32 (rdi a.61 tmp-ra.41 rbp))
     (a.61
      (tmp.32
     ...
     (rsi (r15 rdi rbp a.61 tmp-ra.41))
     (rdi
      (tmp.32 tmp.33 tmp.34 tmp.35 tmp.36 tmp.37 r15 rsi h.68 rbp tmp-ra.41))
     (r15 (rsi rdi rbp))))
   (assignment
    ((a.61 fv2)
     (tmp-ra.41 fv3)
    ...
    ((nfv.43 (r15 nfv.44 h.76 r9 r8 rcx rdx rsi rdi rbp))
     ...
     (tmp-ra.42
      (sum.78
       ...
       fv2
       rbp))
     (i.77 (rdi sum.78 tmp-ra.42 a.69 b.70 c.71 d.72 e.73 f.74 g.75 h.76 rbp))
     (h.76
      (nfv.43
       r9
       r8
     ...
     (rdi
      (i.77
       ...
       tmp-ra.42))
     (r15 (nfv.44 nfv.43 r9 r8 rcx rdx rsi rdi rbp))))
   (assignment ((i.77 fv0) (tmp-ra.42 fv3) (nfv.43 fv4) (nfv.44 fv5))))
  (begin
    (set! tmp-ra.42 r15)
    (set! a.69 rdi)
    (set! b.70 rsi)
